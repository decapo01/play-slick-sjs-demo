package com.example.playslicksjsdemo.controllers.api.v1

import java.util.UUID

import com.example.playslicksjsdemo.common.Repo.Page
import com.example.playslicksjsdemo.crm.Crm.{Customer, CustomerId, CustomerIdAsc, CustomerRepo}
